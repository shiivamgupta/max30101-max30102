...
INT_ENABLE   = 0x02  # Which interrupts are active
FIFO_WR_PTR  = 0x04  # Where data is being written
OVRFLOW_CTR  = 0x05  # Number of lost samples
FIFO_RD_PTR  = 0x06  # Where to read from
FIFO_DATA    = 0x07  # Ouput data buffer
MODE_CONFIG  = 0x09  # Control register
SPO2_CONFIG  = 0x0A  # Oximetry settings
LED_CONFIG   = 0x09  # Pulse width and power of LEDs
TEMP_INTG    = 0x1F  # Temperature value, whole number
TEMP_FRAC    = 0x20  # Temperature value, fraction
...
class MAX30100(object):
    ...
    def __init__(self,
        ...
        self.i2c_write(I2C_ADDRESS, REG_INTR_ENABLE_1, [0xc0])
        self.i2c_write(I2C_ADDRESS, REG_INTR_ENABLE_2, [0x00])
        self.i2c_write(I2C_ADDRESS, REG_FIFO_CONFIG, [0x4f])
        self.i2c_write(I2C_ADDRESS, REG_SPO2_CONFIG, [0x27])
        self.i2c_write(I2C_ADDRESS, REG_LED1_PA, [0x24])
        self.i2c_write(I2C_ADDRESS, REG_LED2_PA, [0x24])
